...
const CARRERAS = {
  // ── CARRERAS ORIGINALES ─────────────────────────────────────────────────────
  ingenieriaIndustrial: { nombre: 'Ingeniería Industrial', codigo: 'II', descripcion: 'Resolución VD-13491-2025 - Escuela de Ingeniería Industrial', cursos: [] },
  contaduriaPublica: { nombre: 'Contaduría Pública', codigo: 'CP', descripcion: 'Escuela de Administración - Universidad de Costa Rica', cursos: [] },
  direccionEmpresas: { nombre: 'Dirección de Empresas', codigo: 'DN', descripcion: 'Escuela de Administración de Negocios - Universidad de Costa Rica', cursos: [] },
  cienciasActuariales: { nombre: 'Ciencias Actuariales', codigo: 'CA', descripcion: 'Bach. y Lic. en Ciencias Actuariales — Plan 1999', cursos: [] },
  farmacia: { nombre: 'Farmacia', codigo: 'FA', descripcion: 'Licenciatura en Farmacia — Plan 2016', cursos: [] },
  ingenieriaQuimica: { nombre: 'Ingeniería Química', codigo: 'IQ', descripcion: 'Licenciatura en Ingeniería Química', cursos: [] },
  economia: { nombre: 'Economía', codigo: 'EC', descripcion: 'Bachillerato en Economía — Plan 2', cursos: [] },
  medicina: { nombre: 'Medicina', codigo: 'ME', descripcion: 'Licenciatura en Medicina y Cirugía', cursos: [] },
  microbiologia: { nombre: 'Microbiología', codigo: 'MQ', descripcion: 'Licenciatura en Microbiología y Química Clínica', cursos: [] },
  // ── NUEVAS CARRERAS (2026) ───────────────────────────────────────────────────
  ingenieriaCivil: { nombre: 'Ingeniería Civil', codigo: 'IC', descripcion: 'Licenciatura en Ingeniería Civil — Plan 3', cursos: [] },
  administracionPublica: { nombre: 'Administración Pública', codigo: 'AP', descripcion: 'Bachillerato y Licenciatura en Administración Pública — Plan 1', cursos: [] },
  arquitectura: { nombre: 'Arquitectura', codigo: 'AQ', descripcion: 'Licenciatura en Arquitectura — Plan 2', cursos: [] },
  computadoras_redes: { nombre: 'Computadoras y Redes', codigo: 'CR', descripcion: 'Bach. Ingeniería Eléctrica - Computadoras y Redes — Plan 2026', cursos: [] },
  electronica_telecomunicaciones: { nombre: 'Electrónica y Telecomunicaciones', codigo: 'ET', descripcion: 'Bach. Ingeniería Eléctrica - Electrónica y Telecomunicaciones — Plan 2026', cursos: [] },
  sistemas_energia: { nombre: 'Sistemas de Energía', codigo: 'SE', descripcion: 'Bach. Ingeniería Eléctrica - Sistemas de Energía — Plan 2026', cursos: [] },
  licenciatura_electrica: { nombre: 'Licenciatura en Ingeniería Eléctrica', codigo: 'LE', descripcion: 'Licenciatura en Ingeniería Eléctrica — Plan 2026', cursos: [] },
  estadistica: { nombre: 'Estadística', codigo: 'ES', descripcion: 'Bachillerato en Estadística — Plan 1', cursos: [] },
  geologia: { nombre: 'Geología', codigo: 'GE', descripcion: 'Bachillerato y Licenciatura en Geología — Plan 2', cursos: [] },
  ingenieriaTopografica: { nombre: 'Ingeniería Topográfica', codigo: 'TP', descripcion: 'Bachillerato en Ingeniería en Topografía — Plan 2003', cursos: [] },
  odontologia: { nombre: 'Odontología', codigo: 'OD', descripcion: 'Bachillerato en Odontología — Plan 2', cursos: [] },
  odontologiaLic: { nombre: 'Odontología (Licenciatura)', codigo: 'OL', descripcion: 'Licenciatura en Odontología — Plan 2011-2017', cursos: [] },
  nutricion: { nombre: 'Nutrición', codigo: 'NU', descripcion: 'Bachillerato y Licenciatura en Nutrición — Plan 3', cursos: [] },
};
